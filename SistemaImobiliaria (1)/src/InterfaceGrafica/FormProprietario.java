        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    psEndereco.setInt(1, proprietario.getEndereco().getId());
                    psEndereco.setInt(2, proprietario.getEndereco().getCep());
                    psEndereco.setString(3, proprietario.getEndereco().getEstado());
                    psEndereco.setString(4, proprietario.getEndereco().getCidade());
                    psEndereco.setString(5, proprietario.getEndereco().getRua());
                    psEndereco.setString(6, proprietario.getEndereco().getBairro());
                    psEndereco.setInt(7, proprietario.getEndereco().getNumero());
                    psEndereco.setString(8, proprietario.getEndereco().getComplemento());
                    ...
                    PreparedStatement psCorretor = Main.imobiliaria.getBanco().getConexao().prepareStatement("INSERT INTO proprietarios (pessoa_id,"
                             + " empresa) VALUES (?, ?)");
                   
                    psCorretor.setInt(1, proprietario.getId());
                    psCorretor.setBoolean(2, proprietario.isEmpresa());
